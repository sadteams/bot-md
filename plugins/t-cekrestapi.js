...
• *ᴇxᴘɪʀᴇᴅ:* ${lol.result.expired}`, m)
            ...
            break
          default:
            return conn.sendButton(m.chat, `*${data.htki} CEK APIKEY ${data.htka}*`, 'sᴇʟᴇᴄᴛ ᴛʏᴘᴇ ᴀᴘɪᴋᴇʏ ʜᴇʀᴇ!', 'xᴛᴇᴀᴍ', `.cekapi ${args[0]} xteam`, 'ʟᴏʟʜᴜᴍᴀɴ', `.cekapi ${args[0]} lolhuman`,m)
        }
      ...
      switch (_type) {
        ...
        default:
          return conn.sendButton( m.chat, wm, wm, `⋮☰ Menu`, `.menu`, m)
      }
    }
  } catch (err) {
    m.reply("Error\n\n\n" + err.stack)
