...
const src = path.join(__dirname, '..', 'system')
...
const genSVG = async ({
    wid = '',
    pp = path.join(system, 'avatar_contact.png'),
    title = '',
    name = '',
    text = '',
    background = ''
...
const render = async ({
    wid = '',
    pp = toBase64(fs.readFileSync(path.join(system, 'avatar_contact.png')), 'image/png'),
    name = '',
    title = '',
    text = '',
    background = toBase64(fs.readFileSync(path.join(system, 'Aesthetic', 'Aesthetic_000.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
