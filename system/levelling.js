import { multiplier } from '../settings.js'
export default {
    /**
     * Growth rate
     * `2.576652002695681`
     ...
     */
    xpRange(level, multiplier = multiplier || 1) {
     ...
     * @param {Number} multiplier 
     */
    findLevel(xp, multiplier = multiplier || 1) {
     ...
     * @param {Number} multiplier 
     */
    canLevelUp(level, xp, multiplier = multiplier || 1) {
